...
Eigen::Vector3f texture_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    for (auto& light : lights)
    {
        ...
        float r_squared = light_dir.squaredNorm();
...
Eigen::Vector3f displacement_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    for (auto& light : lights)
    {
        ...
        float r_squared = light_dir.squaredNorm();
        Eigen::Vector3f l = light_dir.normalized();
        Eigen::Vector3f Ld = kd.cwiseProduct(light.intensity / r_squared) * MAX(0.0f, n.dot(l));
        ...
        Eigen::Vector3f Ls = ks.cwiseProduct(light.intensity / r_squared) * std::pow(MAX(0.0f, n.dot(h)), p);

        result_color += Ld + Ls + Ls;
    }
...
Eigen::Vector3f bump_fragment_shader(const fragment_shader_payload& payload)
{
    ...
    n = (n + Eigen::Vector3f(1.0f, 1.0f, 1.0f)) / 2.0f;
...
int main(int argc, const char** argv)
{
    ...
    // Load .obj File
    bool loadout = Loader.LoadFile(Utils::PathFromAsset("D:\\Code\\GAMES101-Premake-main\\Frame\\Asset\\model\\spot\\spot_triangulated_good.obj"));
    ...
    r.set_texture(Texture(Utils::PathFromAsset("D:\\Code\\GAMES101-Premake-main\\Frame\\Asset\\model\\spot\\hmap.jpg")));
    ...
    if (argc >= 2)
    {
        ...
        if (argc == 3 && std::string(argv[2]) == "texture")
        {
            ...
            r.set_texture(Texture(Utils::PathFromAsset("D:\\Code\\GAMES101-Premake-main\\Frame\\Asset\\model\\spot\\spot_texture.png")));
        }
